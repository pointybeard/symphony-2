...
class AbstractField
{
     ...
     * @var int
     */
    public const __MISSING_FIELDS__ = 200;
     ...
     * @var int
     */
    public const __INVALID_FIELDS__ = 220;
     ...
     * @see mustBeUnique()
     */
    public const __DUPLICATE__ = 300;
     ...
     * @var int
     */
    public const __ERROR_CUSTOM__ = 400;
     ...
     * @var int
     */
    public const __INVALID_QNAME__ = 500;
     ...
     * @var int
     */
    public const __TOGGLEABLE_ONLY__ = 600;
     ...
     * @var int
     */
    public const __UNTOGGLEABLE_ONLY__ = 700;
     ...
     * @var int
     */
    public const __FILTERABLE_ONLY__ = 800;
     ...
     * @var int
     */
    public const __UNFILTERABLE_ONLY__ = 900;
     ...
     * @var int
     */
    public const __FIELD_ALL__ = 1000;
    ...
    {
        $this->_handle = ('field' == strtolower(get_class($this)) ? 'field' : strtolower(substr(get_class($this), 5)));
    }
    ...
    public function setFromPOST(array $settings = array())
    {
        ...
        $settings['show_column'] = (isset($settings['show_column']) && 'yes' === $settings['show_column'] ? 'yes' : 'no');
     ...
     * @param bool  $checkForDuplicates (optional)
    ...
    public function checkFields(array &$errors, $checkForDuplicates = true)
    {
        ...
        if (null !== $this->get('validator') && '' !== $this->get('validator')) {
            if (false === @preg_match($this->get('validator'), 'teststring')) {
     ...
     *
     * @since Symphony 2.3
     * @see https://dev.mysql.com/doc/refman/en/regexp.html
     *
     * @param string $filter
    ...
    public function buildRegexSQL($filter, array $columns, &$joins, &$where)
    {
        ...
        if (preg_match('/^regexp:\s*/i', $filter)) {
            ...
            throw new Exceptions\SymphonyException("Filter `$filter` is not a Regexp filter");
        }
     ...
     *                             is passed by reference and is expected to be used to add additional conditions
     *                             specific to this field
     * @param bool   $andOperation (optional)
     ...
     * @param int   $field_id        (optional)
     *                               the ID of the field that is the parent in the relationship
     * @param int   $parent_entry_id (optional)
