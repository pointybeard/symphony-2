...
namespace Symphony\Symphony\Cryptography;
 ...
 */
class Pbkdf2 extends Symphony\Cryptography
{
    /**
     * Salt length.
     */
    ...
    public static function requiresMigration($hash)
    {
        ...
        if (self::SALT_LENGTH !== $length || self::ITERATIONS !== $iterations || self::KEY_LENGTH !== $keylength) {
            return true;
        } else {
            return false;
        }
