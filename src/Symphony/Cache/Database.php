...
namespace Symphony\Symphony\Cache;
 ...
 */
class CacheDatabase implements Interfaces\NamespacedCacheInterface
{
    /**
    ...
    public function read($hash, $namespace = null)
    {
        ...
        if ($data) {
            if (!$data['data'] = Symphony\Cacheable::decompressData($data['data'])) {
    ...
    public function write($hash, $data, $ttl = null, $namespace = null)
    {
        ...
        if (!$data = Symphony\Cacheable::compressData($data)) {
            return false;
        }
