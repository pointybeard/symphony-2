 ...
 * to view them.
 */
abstract class AbstractDevKitPage extends HtmlPage
{
    /**
    ...
    protected function buildNavigation(\XMLElement $wrapper)
    {
        ...
        if ($root->hasChildNodes()) {
            foreach ($root->childNodes as $node) {
                if ('yes' === $node->getAttribute('active')) {
     ...
     */
    public function prepare(AbstractXsltPage $page, array $pagedata, $xml, array $param, $output)
    {
        $this->_page = $page;
