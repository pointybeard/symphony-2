...
class DateTimeObj
{
    ...
    public static function setDefaultTimezone($timezone)
    {
        if (!@date_default_timezone_set($timezone)) {
            trigger_error(__('Invalid timezone %s', [$timezone]), E_USER_WARNING);
        }
    }
     ...
     * @param string|null $timestamp (optional)
     ...
     *
     * @since Symphony 2.3
     * @see http://au2.php.net/manual/en/class.datetimezone.php
     *
     * @return array
     */
     ...
     * @since Symphony 2.3
     * @see http://au2.php.net/manual/en/class.datetimezone.php
     * @see http://au2.php.net/manual/en/datetimezone.listidentifiers.php
     *
     * @param string $zone
    ...
    public static function getDateFormatsSelectOptions($selected = null)
    {
        ...
        foreach ($formats as $option) {
            ...
            if (false !== strpos($option, 'j') || false !== strpos($option, 'n')) {
