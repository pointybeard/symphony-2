 ...
 */
class EntryManager extends Symphony\AbstractManager
{
    /**
    ...
    protected static function saveFieldData($entry_id, $field_id, $field)
    {
        ...
        try {
            ...
            $table_name = 'tbl_entries_data_'.Symphony\General::intval($field_id);
     ...
     * @return bool
     */
    public static function edit(Symphony\Entry $entry)
    {
    ...
    public static function delete($entries, $section_id = null)
    {
        ...
        if (null !== $section_id) {
            ...
            if ($section instanceof Symphony\Section) {
                ...
                foreach ($fields as $field) {
                    ...
                    $data[$field->get('element_name')] = 'Field' == $reflection->getMethod('entryDataCleanup')->class ? false : true;
                }
            ...
            if ($needs_data) {
                foreach ($entries as $id) {
                    ...
                    if (null === $section_id) {
                        ...
                        if (!$e instanceof Symphony\Entry) {
                            continue;
                        }
    ...
    public static function __buildEntries(array $rows, $section_id, $element_names = null)
    {
                        ...
                        foreach (array_keys($r) as $key) {
                            ...
                            if (
                                (
                                    ...
                                    || null === $raw[$entry_id]['fields'][$field_id][$key]
                                )
        ...
        foreach ($raw as $entry) {
            ...
            $obj->set('creation_date', Symphony\DateTimeObj::get('c', $entry['meta']['creation_date']));

            if (isset($entry['meta']['modification_date'])) {
                $obj->set('modification_date', Symphony\DateTimeObj::get('c', $entry['meta']['modification_date']));
            } else {
    ...
    {
        if (null != $entriesPerPage && !is_string($entriesPerPage) && !is_numeric($entriesPerPage)) {
            throw new Exceptions\SymphonyException(__('Entry limit specified was not a valid type. String or Integer expected.'));
        } elseif (null == $entriesPerPage) {
            ...
            $records = ('0' == $entriesPerPage ? null : self::fetch(null, $section_id, $entriesPerPage, $start, $where, $joins, $group, $buildentries, $element_names));
