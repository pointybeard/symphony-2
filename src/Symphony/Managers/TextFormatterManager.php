 ...
 */
class TextformatterManager extends Symphony\AbstractManager implements Interfaces\FileResourceInterface
{
    /**
    ...
    {
        $result = [];
        $structure = Symphony\General::listStructure(TEXTFORMATTERS, '/formatter.[\\w-]+.php/', false, 'ASC', TEXTFORMATTERS);
        ...
        if (is_array($extensions) && !empty($extensions)) {
            foreach ($extensions as $e) {
                ...
                $tmp = Symphony\General::listStructure(EXTENSIONS."/$e/text-formatters", '/formatter.[\\w-]+.php/', false, 'ASC', EXTENSIONS."/$e/text-formatters");
