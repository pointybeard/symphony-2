 ...
 */
class DatasourceManager extends Symphony\AbstractManager implements Interfaces\FileResourceInterface
{
    /**
    ...
    {
        $result = [];
        $structure = Symphony\General::listStructure(DATASOURCES, '/data.[\\w-]+.php/', false, 'ASC', DATASOURCES);
        ...
        if (is_array($extensions) && !empty($extensions)) {
            foreach ($extensions as $e) {
                ...
                $tmp = Symphony\General::listStructure(EXTENSIONS."/{$e}/data-sources", '/data.[\\w-]+.php/', false, 'ASC', EXTENSIONS."/{$e}/data-sources");
